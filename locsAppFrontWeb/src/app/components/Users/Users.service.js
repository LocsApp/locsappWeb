(function () {
  ...
  function UsersService($log, $resource, URL_API, $sessionStorage, $localStorage, Upload) {
    ...
    var service = {
      ...
      living_addresses: $resource(URL_API + 'api/v1/user/:id/living_addresses/', {id: "@user_id"}, {'update': {method: 'PUT'}}),
      living_addresses_delete: $resource(URL_API + 'api/v1/user/:id/living_addresses/delete/', {id: "@user_id"}),
      billing_addresses: $resource(URL_API + 'api/v1/user/:id/billing_addresses/', {id: "@user_id"}, {'update': {method: 'PUT'}}),
